<<<<<<< HEAD
//package com.skpl.mailapp.mail.client;
//
...
//        }
//        //发送用户名
//        result = sendCommand(Base64.encode(from.getBytes()) + lineFeet);
//        System.out.println( result);
//        if (!isStartWith(result, "334")) {
...
//        //EBQKCKORKNUDKVYF
//        //LWVRFAFKZCZWVEBC
//        result = sendCommand(Base64.encode(userPassword.getBytes()) + lineFeet);
//        System.out.println(result);
